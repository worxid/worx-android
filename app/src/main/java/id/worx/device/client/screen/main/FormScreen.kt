...
@Composable
fun DraftItemForm(item: SubmitForm, viewModel: HomeViewModel, detailFormViewModel: DetailFormViewModel) {
    Row(
        modifier = Modifier
            .fillMaxWidth()
            .border(1.5.dp, color = Color.Black)
        ...
        Image(
            modifier = Modifier
                .padding(horizontal = 16.dp),
            painter = painterResource(id = R.drawable.ic_form_red),
            contentDescription = "Form Icon",
        )
        Column(modifier = Modifier.padding(vertical = 13.dp)) {
            Row() {
...
@Composable
fun SubmissionItemForm(item: SubmitForm, viewModel: HomeViewModel, detailFormViewModel: DetailFormViewModel) {
    Row(
        modifier = Modifier
            .fillMaxWidth()
            .border(1.5.dp, color = Color.Black)
